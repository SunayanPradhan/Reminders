...
import com.sunayanpradhan.reminders.databinding.ActivityAllRemindersBinding
...
class AllRemindersActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_all_reminders)
    ...
    private fun setUpReminderAdapter(){
        ...
        val query=FirebaseFirestore.getInstance().collection("reminders").document(FirebaseAuth.getInstance().uid.toString())
            .collection("myReminders").whereEqualTo("reminderCompleted",false)
