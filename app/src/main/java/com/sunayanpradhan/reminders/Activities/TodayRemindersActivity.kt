...
import com.sunayanpradhan.reminders.databinding.ActivityTodayRemindersBinding
import java.util.*

class TodayRemindersActivity : AppCompatActivity() {

    private lateinit var binding: ActivityTodayRemindersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_today_reminders)
    ...
    private fun setUpReminderAdapter(){
        ...
        val query=FirebaseFirestore.getInstance().collection("reminders").document(FirebaseAuth.getInstance().uid.toString())
            .collection("myReminders").whereLessThan("reminderDate", Date().time+86400000)
